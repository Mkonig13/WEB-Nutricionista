...
<head>
    ...
    <title>Lic. Carla Cuenca - Registro</title>
    <!-- Favicon -->
        ...
        <div class="contact-form">
            ...
            <form id="formRegistro" >
                ...
                <div class="input-container">
                    <input type="text" name="nombre" placeholder="Nombre completo" class="input">
                    <label for=""></label>
                </div>
                ...
                <div class="input-container">
                    <input type="text" name="telefono" placeholder="Telefono" class="input">
                    <label for=""></label>
                </div>

                <div class="btn-form-container">
                    <input type="submit" value="Registrarse" class="btn custom-btn btn-form">
                </div>
...
<script>
        $(document).ready(function(){
            $('#formRegistro').on('submit', function(event) {
                ...
                $.ajax({
            type: 'POST',
            url: 'php/registroScript.php', // Ruta al archivo PHP que procesará los datos
            data: formData,
