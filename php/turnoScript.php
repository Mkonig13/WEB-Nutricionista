...
*/
    ...
    $consulta_existencia = mysqli_query($conexion, "SELECT * FROM turnos where dia = '$dia' && hora ='$hora'");
        ...
        if(mysqli_num_rows($consulta_existencia) > 0){
            ...
            $sql =  "INSERT INTO turnos(dia, hora, usuario_id) 
            VALUES (?, ?, ?)";
...
$e_mail->isHTML(true);
$e_mail->Subject="Confirmacion de turno";
$e_mail->Body = "Hola " . $nombre . ", tu turno se agendo satisfactoriamente para el dia " . $dia . " a las " . $hora . "hs, gracias por confiar";
